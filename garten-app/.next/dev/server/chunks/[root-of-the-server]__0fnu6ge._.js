...
"[project]/Documents/Abisgarten-go/src/proxy.js [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Abisgarten$2d$go$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Abisgarten-go/node_modules/next/server.js [middleware] (ecmascript)");
;
let locales = [
    'de',
    'en',
...
function proxy(request) {
    ...
    if (pathname.startsWith('/_next') || pathname.startsWith('/api') || pathname.includes('/images/') || pathname.includes('/favicon.ico')) {
        return;
    }
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Abisgarten$2d$go$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(request.nextUrl);
}
const config = {
    matcher: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0fnu6ge._.js.map